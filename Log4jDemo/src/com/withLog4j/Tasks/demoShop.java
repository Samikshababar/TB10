...
public class demoShop {
	static Logger log=Logger.getLogger(demoShop.class.getName());
	public WebDriver driver;
	Properties p=new Properties();
	@BeforeSuite
	public void browser() throws IOException
	{
		FileInputStream file=new FileInputStream("S:\\core java eclipse codeNew\\Log4jDemo\\src\\parameters.properties");
		p.load(file);
